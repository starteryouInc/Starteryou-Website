...
const NewsLetter = () => {
  return (
    <div className="relative overflow-hidden mx-4 my-12 p-12 lg:p-0 bg-[#6a54df] text-white flex flex-col justify-center items-center rounded-[18px] space-y-4 lg:w-[1166px] lg:h-[266px]">
