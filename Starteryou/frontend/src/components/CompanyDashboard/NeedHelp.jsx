/**
 * NeedHelp Component - Displays a support message with a contact button.
 *
 * @component
...
const NeedHelp = () => {
  return (
    <div className="need-help w-[370px] h-[240px] px-4 bg-[#f2fce2] flex flex-col items-center justify-center space-y-4  rounded-lg">
