...
const { applyJobHandler, fetchAppliedJobHandler, fetchAppliedUsersHandler, updateAppliedJobStatusHandler } = require("../handlers/JobApplicationHandlers");
 ...
 */
router.post("/:jobId/apply-job", authorize("jobSeeker"), 
applyJobHandler
// async (req, res) => {
 ...
 */
router.get("/fetch-applied-jobs", authorize("jobSeeker"), 
