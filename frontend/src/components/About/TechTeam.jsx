...
TechTeam.metadata = {
  componentName: "TechTeam",
  page: "AboutPage",
  description:
    "Displays the Tech Team members with names, positions, images, and LinkedIn profiles. Allows admins to add and remove members.",
  editable: true,
  imageSupport: true,
  apiEndpoint: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.teamApi}`,
};
