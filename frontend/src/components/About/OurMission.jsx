...
OurMission.metadata = {
  componentName: "OurMission",
  page: "AboutPage",
  description:
    "Manages the 'Our Mission' section by displaying and editing the mission title, description, and image upload functionality for admin users.",
  editable: true,
  fileUploadSupport: true,
  apiEndpoints: {
    text: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.textApi}`,
    fileDownload: (title) => `${API_CONFIG.baseURL}${API_CONFIG.endpoints.fileDownload(title)}`,
    fileUpdate: (title) => `${API_CONFIG.baseURL}${API_CONFIG.endpoints.fileUpdate(title)}`,
  },
};
