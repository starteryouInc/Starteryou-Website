...
BetterFuture.metadata = {
  componentName: "BetterFuture",
  page: "AboutPag e",
  description:
    "Displays a video with play/pause functionality, dynamic heading and paragraph content, and allows admins to edit and save the content.",
  editable: true,
  videoSupport: true,
