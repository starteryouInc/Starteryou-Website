...
EmployerSignUp.metadata = {
  componentName: "EmployerSignUp",
  page: "AuthPage",
  description:
    "Handles employer signup by collecting company details and user credentials. Integrates API for registration and authentication.",
  editable: false,
  apiEndpoint: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.userEmpRegister}`,
};
