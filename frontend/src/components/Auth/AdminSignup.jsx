...
AdminSignup.metadata = {
  componentName: "AdminSignup",
  page: "AuthPage",
  description:
    "Handles admin signup with email validation and API integration. Restricts signup to emails ending in @starteryou.com.",
  editable: false,
  apiEndpoint: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.authRegister}`,
};
