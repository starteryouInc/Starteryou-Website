...
Signup.metadata = {
  ...
  page: "AuthPage",
  description:
    "Handles user registration for job seekers, including API integration for account creation and profile setup.",
  editable: true,
  apiEndpoints: {
    registerUser: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.userSeekerRegister}`,
    createProfile: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.createUserProfile}`,
  },
