...
UserLogin.metadata = {
  componentName: "UserLogin",
  page: "AuthPage",
  description:
    "Handles user authentication by verifying credentials and managing login sessions.",
  editable: true,
  redirectPaths: {
    jobSeeker: "/jobfeeds",
    default: "/",
  ...
  apiEndpoints: {
    loginUser: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.userLogin}`,
  },
};
