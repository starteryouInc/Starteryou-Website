...
LoginPage.metadata = {
  ...
  page: "AuthPage",
  description:
    "Handles admin login functionality with email validation and API integration. Implements lockout mechanism after three failed attempts.",
  editable: false,
  apiEndpoint: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.authLogin}`,
  lockoutDuration: 30,
};
