...
ExploreJob.metadata = {
  componentName: "ExploreJob",
  description:
    "A component designed for college students and recent graduates to explore job opportunities tailored to their skills and interests.",
  features: {
    jobExploration: true, // Allows users to explore job opportunities
  ...
  accessibility: {
    linkText: "Link to search for job opportunities based on user skills",
  },
  styles: {
    container: {
