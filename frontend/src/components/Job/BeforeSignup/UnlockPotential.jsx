...
UnlockPotential.metadata = {
  ...
  description:
    "A component that allows users to view and edit the promotional content for the 'Unlock Your Potential' section, including image upload functionality for admins.",
  features: {
    imageUpload: true, // Allows admins to upload an image
    textEditing: true, // Enables text editing for title and paragraph
    wordLimitFeedback: true, // Provides real-time feedback on word limits for inputs
  },
  data: {
    title: "Unlock Your Potential with Starteryou: Your Path to Career Success",
    paragraph:
      "Starteryou offers students the chance to gain valuable work experience while balancing their studies. With flexible job opportunities tailored to your schedule, you can enhance your resume and prepare for a successful career.",
  },
  accessibility: {
    editingMode: "Editable fields for title and paragraph enhance accessibility.",
    notifications: "Toast notifications inform users of upload and save actions.",
  },
  styles: {
    container: {
      maxWidth: "1430px", // Max width for the main container
      margin: "0 auto", // Center alignment for the container
      padding: "1.75rem 1rem", // Padding for the container
    },
    inputField: {
    ...
    button: {
      save: {
        backgroundColor: "#3B82F6", // Background color for the Save button
