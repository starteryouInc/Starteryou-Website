...
JobListing.metadata = {
  componentName: "JobListing",
  description:
    "A component designed for college students to discover tailored job listings. It allows admins to edit content and upload relevant images.",
  features: {
    contentEditing: true, // Allows admins to edit the title and paragraph
    ...
    wordValidation: true, // Validates word limits for title and paragraph
  },
  data: {
    title: "Discover Job Listings Curated Specifically for College Students",
    paragraph:
      "At Starteryou, we understand the unique needs of college students seeking job opportunities. Our platform offers a tailored selection of job listings designed to help you kickstart your career.",
    jobInfo: [
      {
  ...
  styles: {
    container: {
      maxWidth: "1430px", // Maximum width for the component
