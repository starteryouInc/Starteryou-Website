...
DiscoverPath.metadata = {
  componentName: "DiscoverPath",
  description:
    "A component that showcases job opportunities for students and allows for the uploading of images related to those opportunities.",
  features: {
    jobOpportunities: true, // Displays various job opportunities for students
    imageUpload: true, // Allows admins to upload images related to job opportunities
    editingMode: true, // Enables editing mode for admins to update content
  },
  opportunitiesData: [
    {
      title: "Gain Real-World Experience with Internships and Part-Time Opportunities",
      description:
        "Explore valuable internships and part-time jobs tailored for your academic journey.",
      linkText: "Apply",
      linkUrl: "#",
    ...
    {
      title: "Streamlined Job Listings for Students Seeking Flexible Work Options",
      description:
        "Find job listings that cater to your unique schedule and academic commitments.",
      linkText: "Browse",
      linkUrl: "#",
  ...
  styles: {
    ...
    opportunityCard: {
      ...
      shadow: "md", // Shadow for opportunity cards
      borderRadius: "lg", // Rounded corners for opportunity cards
    },
    opportunityTitle: {
      fontSize: "1.25rem", // Font size for opportunity title
      fontWeight: "semibold",
    },
    tags: {
