  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-60 backdrop-blur-sm">
      <div className="bg-white p-6 rounded-xl shadow-2xl max-w-3xl w-full h-[80vh] flex flex-col relative border border-gray-200">
        ...
        <iframe
          src="/STARTERYOU TERMS OF SERVICE.pdf#toolbar=0"
...
TermsModal.metadata = {
  componentName: "TermsModal",
  description:
    "A modal component that displays the terms and conditions as a PDF. It includes a close button, a loading spinner while the PDF is loading, and manages visibility based on the `isOpen` prop.",
  features: {
    modalDisplay: true,
  ...
  accessibility: {
    modalAriaLabel: "Terms and Conditions Modal",
    closeButtonLabel: "Close Terms and Conditions",
  },
  styles: {
    backdrop: {
  ...
  apiIntegration: {
    pdfSource: "/STARTERYOU TERMS OF SERVICE.pdf",
  },
  children: {
