...
NewsLetter.metadata = {
  ...
  description:
    "A newsletter subscription form that allows users to enter their name and email address. It includes input validation and submits the data to the backend, displaying toast notifications for user feedback.",
  features: {
  ...
  styles: {
    ...
    formBackground: "#6a54df",
    buttonBackground: "#D9502E",
    borderColor: "#d4d4d8",
    decorativeCircles: {
      circleOne: {
        borderColor: "#8574e4",
  ...
  apiIntegration: {
    endpoint: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.newsletterApi}`,
    method: "POST",
    successMessage: "Subscription successful!",
    errorMessage: "An error occurred. Please try again.",
    warningMessage: "Email is already subscribed.",
  },
  children: {
