  ...
  return (
    <footer className="relative bg-[#F8FAFC] p-6 overflow-hidden">
      ...
      <div className="text-center py-6 text-gray-500">
        © Copyright 2024, All Rights Reserved by Starteryou, Inc.
      </div>
    </footer>
  );
};
...
Footer.metadata = {
  ...
  description:
    "A footer component that provides links to social media, company information, resources, and help options. It includes modals for terms and privacy policies.",
  features: {
  ...
  states: {
    ...
    isModalPrivacy: {
      type: "boolean",
      description: "Controls the visibility of the privacy modal.",
    },
  },
  accessibility: {
    logoAltText: "Logo",
    socialMediaLinks: "Link to social media profiles",
  },
  children: {
    TermsModal: {
      description: "Modal component for displaying terms and conditions.",
    },
    Privacy: {
      description: "Modal component for displaying privacy policy.",
    },
  },
};
