...
OurInsight.metadata = {
  componentName: "OurInsight",
  description:
    "A component that displays a collection of insights in a blog format, allowing users to read about educational resources and career tips.",
  features: {
    imageUpload: true, // Image upload feature for admin users
  ...
  insights: [
    {
      ...
      type: "Education",
      title: "The Future of Online Learning",
      description: "Discover how online education is transforming the learning landscape.",
      link: "/read-more-1",
    },
    {
      id: 2,
      type: "Career",
      title: "Building Your Professional Network",
      description: "Learn effective strategies for networking in today's job market.",
      link: "/read-more-2",
    },
    {
      id: 3,
      type: "Learning",
      title: "Top Skills for Future Careers",
      description: "Identify essential skills that will boost your employability.",
      link: "/read-more-3",
    },
  ],
  accessibility: {
  ...
  content: {
    placeholderImage: "/JobPortalPage/Placeholder Image.png",
    insightsLink: [
      "/read-more-1",
      "/read-more-2",
      "/read-more-3",
