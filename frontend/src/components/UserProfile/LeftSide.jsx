...
LeftSide.metadata = {
  componentName: "LeftSide",
  description:
    "A component that displays user profile information, allowing users to edit and update their profile details and social media links.",
  features: {
    userAuthentication: true, // Requires user to be authenticated to edit profile
    inputValidation: true, // Validates input fields for profile details
    toastNotifications: true, // Provides feedback on profile update success or error
    socialLinksEditing: true, // Allows users to edit social media links
  },
  data: {
    initialProfileData: {
      name: "John Oliver",
    ...
    imageSources: {
      defaultProfileImage: "/UserProfile/defaultProfileImage.png", // Default profile image before upload
    },
  },
  accessibility: {
    formLabels: "Labels are clearly associated with input fields for better accessibility.",
    editable: "Allows users to edit their profile content easily.",
    imageAltText: "Profile images have appropriate alt text for accessibility.",
  },
  styles: {
    container: {
    ...
    profileDetails: {
      fontSize: "1rem", // Font size for profile details
      color: "#333", // Text color for profile details
    },
    buttons: {
      save: {
        backgroundColor: "#4CAF50", // Background color for the save button
        color: "white", // Text color for the save button
      },
      edit: {
        backgroundColor: "#007BFF", // Background color for the edit button
  ...
  apiEndpoints: {
    fetchUserProfile: {
      method: "GET",
      url: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.getUserProfile}`, // Endpoint for fetching user profile
      description: "Fetches the user profile information based on user ID.",
      successResponse: {
        status: 200,
    ...
    updateUserProfile: {
      method: "PATCH",
      url: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.updateUserProfile(":userId")}`, // Endpoint for updating user profile
      description: "Updates the user profile information.",
      requestBody: {
        professionalTitle: "string", // Updated job title
        location: "string", // Updated location
        currentCompany: "string", // Updated current company
        totalExperience: "string", // Updated total experience
