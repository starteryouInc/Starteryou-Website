...
CoursCertiForm.metadata = {
  componentName: "CoursCertiForm",
  description:
    "A form component that allows users to submit courses and certifications, including details like title, issuer, URL, and expiry information.",
  features: {
    userAuthentication: true, // Requires user to be authenticated to submit certificates
    inputValidation: true, // Validates required fields before submission
    toastNotifications: true, // Provides feedback on form submission success or error
    clearableForm: true, // Allows users to clear all form fields
    checkboxInput: true, // Supports checkbox for indicating non-expiring credentials
  },
  data: {
    initialContent: {
      certificateTitle: "", // Initial title for the certificate
      ...
      year: "", // Initial year for the expiry date
      month: "", // Initial month for the expiry date
    },
  },
  accessibility: {
    ...
    clearFields: "Allows users to easily clear all input fields.",
    ariaLabels: "Checkbox and select elements have appropriate aria labels for screen readers.",
  },
  styles: {
    container: {
      maxWidth: "3xl", // Maximum width for the form
    ...
    title: {
      fontSize: "2rem", // Font size for the form title
      fontWeight: "bold", // Font weight for the form title
    },
    labels: {
      fontSize: "1rem", // Font size for the labels
      color: "#777585", // Text color for the labels
    },
    input: {
      ...
      focus: {
        ...
        ring: "2px solid #6a54df", // Outline color on focus
      },
    },
  },
  apiEndpoints: {
    addCertificate: {
      method: "POST",
      url: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.addCertificate(":userId")}`, // Endpoint for adding a new certificate
      description: "Submits the new certificate details for the authenticated user.",
      requestBody: {
        title: "string", // Certificate title
        issuedBy: "string", // Issuer of the certificate
        expiryDate: "date | null", // Expiry date of the certificate, can be null
      ...
      errorResponse: {
        status: 400,
        message: "Error occurred while adding the certificate.",
      },
    },
  },
};
