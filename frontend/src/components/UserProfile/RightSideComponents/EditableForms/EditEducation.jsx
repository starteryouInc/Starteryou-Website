...
EditEducation.metadata = {
  componentName: "EditEducation",
  description:
    "A form component for editing educational details, including qualification, specialization, institute, marks, and years.",
  features: {
    userAuthentication: true, // Requires user to be authenticated to edit education
  ...
  data: {
    initialContent: {
      ...
      specialization: "", // Specialization in the degree
      institute: "", // Name of the educational institute
      marks: "", // Marks obtained
      startYear: "", // Start year of the education
      passingYear: "", // Year of passing
      description: "", // Description of the educational experience
    },
  },
  accessibility: {
  ...
  apiEndpoints: {
    updateEducation: {
      method: "PUT",
      url: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.updateEducation(":userId", ":educationId")}`, // Endpoint for updating education
      description: "Updates an existing education entry for the authenticated user.",
      requestBody: {
        userId: "string", // The ID of the user
        educationId: "string", // The ID of the education entry to be updated
        institution: "string", // Name of the educational institute
        degree: "string", // Degree obtained
        specialization: "string", // Specialization in the degree
        startYear: "Date", // Start year of the education
        endYear: "Date|string", // End year of the education (can be "Present")
        Marks: "number", // Marks obtained
        description: "string", // Description of the educational experience
      },
      successResponse: {
        status: 200,
