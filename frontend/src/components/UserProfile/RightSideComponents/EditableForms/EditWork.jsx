...
EditWork.metadata = {
  componentName: "EditWork",
  description:
    "A component that allows users to edit their work experience details, including job title, company name, start and end dates, and job description.",
  features: {
    userAuthentication: true, // Requires user to be authenticated to edit work experience
    inputValidation: true, // Validates input fields for required fields
    toastNotifications: true, // Provides feedback on submission success or error
    adminControls: false, // Only standard users can edit their work experience
    imageUpload: false, // This component does not support image uploads
  },
  data: {
    initialContent: {
      jobTitle: "Software Engineer", // Example initial job title
      companyName: "Tech Corp", // Example initial company name
      description: "Worked on various projects involving React and Node.js.", // Example initial description
    },
  },
  accessibility: {
    ...
    editable: "Allows users to edit their work experience easily.",
  },
  styles: {
    container: {
    ...
    inputFields: {
      ...
      borderRadius: "4px", // Border radius for input fields
    },
    buttons: {
      save: {
  ...
  apiEndpoints: {
    updateWorkExperience: {
      method: "PUT",
      url: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.updateWorkExperience(":userId", ":jobId")}`, // Endpoint for updating work experience
      description: "Updates the user's work experience based on the provided job ID.",
      requestBody: {
        companyName: "string", // Company name
        jobTitle: "string", // Job title
        startDate: "Date", // Start date in ISO format
        endDate: "Date | null", // End date in ISO format or null for current jobs
