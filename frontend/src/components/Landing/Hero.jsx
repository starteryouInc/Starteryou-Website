...
Hero.metadata = {
  componentName: "Hero",
  description: "A hero section component with editable title and paragraph, image upload functionality, and background effects.",
  features: {
    responsiveDesign: true, // Adapts layout for different screen sizes
    imageUpload: true, // Allows users to upload images for the hero section
    textEditing: true, // Enables editing of title and paragraph text
    errorHandling: true, // Manages error states for image uploads and data fetching
  },
  accessibility: {
    altText: "Images should include descriptive alt text for accessibility.",
    inputLabels: "Inputs for editing title and paragraph should have clear labels.",
  },
  styles: {
    container: {
      backgroundColor: "#2700D3", // Background color for the hero section
      textColor: "white", // Text color
      overflow: "hidden", // Prevents overflow of child elements
    },
    glowEffect: {
      backgroundColor: "#E5F1FF", // Background glow color
      filter: "blur(100px)", // Blur effect for glow
      opacity: "0.8", // Opacity for the glow effect
    },
  },
  apiEndpoints: {
    fetchImages: {
      method: "GET",
      url: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.fileByTitle(":title")}`, // Fetch images by title
      description: "Fetches images based on their titles.",
      successResponse: {
        status: 200,
    ...
    updateImage: {
      method: "PUT",
      url: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.fileUpdate(":imageType")}`, // Update images
      description: "Updates an image based on the provided title.",
      requestBody: {
    ...
    fetchTextData: {
      method: "GET",
      url: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.textApi}`, // Fetch hero text data
      description: "Fetches the title and paragraphs for the hero section.",
      successResponse: {
        status: 200,
      ...
      errorResponse: {
        status: 400,
        message: "Error fetching text data.",
      },
    },
    saveContent: {
      method: "PUT",
      url: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.textApi}`, // Save edited title and paragraphs
      description: "Saves the edited title and paragraphs for the hero section.",
      requestBody: {
        page: "HomePage", // The page for which data is being saved
        component: "Hero", // The component name
        content: "string", // Edited title
        paragraphs: "array", // Edited paragraphs
      },
      successResponse: {
        status: 200,
