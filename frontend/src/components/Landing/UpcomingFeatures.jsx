...
UpcomingFeatures.metadata = {
  componentName: "UpcomingFeatures",
  description: "A carousel component displaying upcoming features with image upload functionality for admins.",
  features: {
    carouselDisplay: true, // Displays a carousel of upcoming features
    imageUpload: true, // Allows admins to upload images for each feature
    responsiveDesign: true, // Adapts layout for different screen sizes
  },
  accessibility: {
    ariaLabels: "Images and upload buttons should have clear aria-labels for accessibility.",
    errorHandling: "Error messages are displayed for failed image uploads or fetching.",
  },
  styles: {
    container: {
      padding: "py-16", // Padding for the container
      background: "linear-gradient(106.35deg, rgba(205, 243, 246, 0.4) -1.21%, rgba(187, 174, 253, 0.4) 106.79%)", // Background gradient
    },
    heading: {
      fontSize: "text-3xl md:text-4xl", // Font size for the heading
      fontWeight: "font-medium", // Font weight for the heading
      marginBottom: "mb-8 md:mb-12", // Bottom margin for spacing
    },
    carousel: {
      width: "max-w-[800px]", // Max width for the carousel
    },
    image: {
      height: "400px", // Fixed height for images in the carousel
      width: "100%", // Full width for images
    },
    uploadButton: {
      backgroundColor: "bg-blue-700", // Background color for upload button
      hoverEffect: "hover:bg-blue-600 transition-colors duration-300", // Hover effect for button
    },
  },
  slidesData: [
    {
