...
estJob.metadata = {
  componentName: "BestJob",
  description:
    "A component that displays job-related information, allowing admins to upload images and edit job titles and descriptions.",
  features: {
  ...
  data: {
    ...
    imageSources: {
      image1: "/LandingPage/Rectangle.png",
      image2: "/LandingPage/Heroimg2.jpg",
    },
  },
  accessibility: {
  ...
  apiEndpoints: {
    fetchContent: {
      ...
      description: "Fetches the content for the job section based on page and component.",
      successResponse: {
        status: 200,
