...
Blog.metadata = {
  componentName: "Blog",
  description:
    "A component that allows users to display blog-related information, edit titles and descriptions, and navigate through various blog entries.",
  features: {
    ...
    toastNotifications: true, // Provides feedback on data save success or error
    adminControls: true, // Allows admin users to edit blog content
  },
  data: {
    initialContent: {
      title: "Our Blog",
      paragraph: "Stay informed and inspired with our latest insights on job hunting, career growth, and industry trends.",
    },
    blogBoxes: [
      {
        img: "/LandingPage/Blogimg1.png",
        title: "Portfolio: A Step-by-Step Guide to Crafting an Outstanding High School Portfolio",
        date: "20 Jan 2023",
        category: "Job Hunting",
        text: "Crafting an Outstanding High School Portfolio: A Step-by-Step Guide",
      },
      {
        img: "/LandingPage/Blogimg2.png",
        title: "The Ultimate Guide for High School Students! to Applying for and Getting into College",
        date: "21 Jan 2023",
        category: "Get Inspired",
        text: "Applying for and Getting into College: The Ultimate Guide for High School Students!",
      },
  ...
  accessibility: {
    ...
    editable: "Allows admins to edit blog content easily.",
  },
  styles: {
    container: {
      maxWidth: "1440px", // Maximum width for the container
  ...
  apiEndpoints: {
    fetchContent: {
      method: "GET",
      url: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.textApi}`, // Endpoint for fetching blog content
      description: "Fetches the content for the Blog component based on page and component.",
      successResponse: {
        status: 200,
    ...
    saveContent: {
      method: "PUT",
      url: `${API_CONFIG.baseURL}${API_CONFIG.endpoints.textApi}`, // Endpoint for saving blog content
      description: "Saves the updated blog content.",
      requestBody: {
        page: "HomePage",
        component: "Blogs",
